...
def get_ingress(cluster_details,namespace="default",all_namespaces=True):
...
def create_ingress(cluster_details,yaml_body=None,namespace="default"):
    ...
    try:
        ...
        yaml_data=open("ingress-create.yml", "rb").read().decode('utf-8')
        ...
        print("Ingress created: {}".format(data))
...
if __name__ == '__main__':
    ...
    get_ingress(cluster_details)
    # create_ingress(cluster_details)
